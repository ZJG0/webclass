...
<head lang="en">
    ...
    <link href="/webzuoye/Public/chajian/css/video-js.css" rel="stylesheet">
    <!-- If you'd like to support IE8 -->
    <script src="/webzuoye/Public/chajian/js/videojs-ie8.min.js"></script>
    <style>
        ...
        .m{ width: 1100px; height: 600px; margin-left: auto; margin-right: auto; margin-top: 20px; }
    </style>
</head>
<body>
<div class="weizhi">
    <div class="weizhi_title">
        <span class="glyphicon glyphicon-volume-up"></span>课程视频
    </div>
</div>
