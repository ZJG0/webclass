  ...
  <div class="container-fluid padTa">
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-7" style="text-align: right">
            <ul class="pagination">
                <?php if($page > 1): ?><li><a href="<?php echo U('Admin/yiTongGuo');?>?page=<?php echo ($page-1); ?>">&laquo;</a></li><?php endif; ?>
                <?php $__FOR_START_25788__=0;$__FOR_END_25788__=$allPage;for($i=$__FOR_START_25788__;$i < $__FOR_END_25788__;$i+=1){ ?><li><a class="x<?php echo ($i+1); ?> "  href="<?php echo U('Admin/yiTongGuo');?>?page=<?php echo ($i+1); ?>"><?php echo ($i+1); ?></a></li><?php } ?>
                <?php if($page < $allPage): ?><li><a href="<?php echo U('Admin/yiTongGuo');?>?page=<?php echo ($page+1); ?>">&raquo;</a></li><?php endif; ?>
            </ul>
        </div>
    </div>
  </div>
