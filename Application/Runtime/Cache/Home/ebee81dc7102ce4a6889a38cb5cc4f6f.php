...
<div class="container-fluid padTa">
    <table class="table gTable table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td id="shenpi1"><span class="glyphicon glyphicon-file" style="color: green;"></span>
                    <a href="<?php echo U('User/informContent');?>?id=<?php echo ($vo["id"]); ?>">详情</a>
                </td>
    ...
    <div class="row">
       <div class="col-sm-5 col-sm-offset-2" style="text-align: center">
            <ul class="pagination">
                <?php if($page > 1): ?><li><a href="<?php echo U('User/inform');?>?page=<?php echo ($page-1); ?>">&laquo;</a></li><?php endif; ?>
                <?php $__FOR_START_23995__=0;$__FOR_END_23995__=$allPage;for($i=$__FOR_START_23995__;$i < $__FOR_END_23995__;$i+=1){ ?><li><a class="x<?php echo ($i+1); ?> "  href="<?php echo U('User/inform');?>?page=<?php echo ($i+1); ?>"><?php echo ($i+1); ?></a></li><?php } ?>
                <?php if($page < $allPage): ?><li><a href="<?php echo U('User/inform');?>?page=<?php echo ($page+1); ?>">&raquo;</a></li><?php endif; ?>
            </ul>
        </div>
    </div>
</div>
