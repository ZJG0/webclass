...
<div class="weizhi">
    <div class="weizhi_title">
        <span class="glyphicon glyphicon-list-alt"></span>未审批
    </div>
</div>
  ...
  <div class="container-fluid padTa">
    <table class="table gTable table-bordered" style="word-break: normal;">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <span class="glyphicon glyphicon-file span1" style="color:#c21f3c"><a href="<?php echo U('Admin/detail');?>?id=<?php echo ($vo["id"]); ?>" target="cont">详情</a></span>
            </td>
    ...
    <div class="row">
        <div class="col-sm-5 col-sm-offset-7" style="text-align: right">
            <ul class="pagination">
                <?php if($page > 1): ?><li><a href="<?php echo U('Admin/weiShenPi');?>?page=<?php echo ($page-1); ?>">&laquo;</a></li><?php endif; ?>
                <?php $__FOR_START_30895__=0;$__FOR_END_30895__=$allPage;for($i=$__FOR_START_30895__;$i < $__FOR_END_30895__;$i+=1){ ?><li><a class="x<?php echo ($i+1); ?> "  href="<?php echo U('Admin/weiShenPi');?>?page=<?php echo ($i+1); ?>"><?php echo ($i+1); ?></a></li><?php } ?>
                <?php if($page < $allPage): ?><li><a href="<?php echo U('Admin/weiShenPi');?>?page=<?php echo ($page+1); ?>">&raquo;</a></li><?php endif; ?>
            </ul>
        </div>
    </div>
  </div>
