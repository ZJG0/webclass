...
<div class="weizhi">
    <div class="weizhi_title">
        <span class="glyphicon glyphicon-volume-up"></span>实验指导书
    </div>
</div>
<div class="container-fluid">
    ...
    <div class="container" style="margin-top: 30px;padding-bottom: 20px;border: 1px solid #eee;box-shadow: 1px 1px 1px #eee;">
      ...
      <tr>
          <td>软件测试实验指导书14版</td>
          <td><a href="/webzuoye/Public/doc/1.doc"><button type="button" class="btn btn-primary">下载</button></a></td>
      </tr>
      <tr>
          <td>实验二 白盒测试用例设计03版</td>
          <td><a href="/webzuoye/Public/doc/2.doc"><button type="button" class="btn btn-primary">下载</button></a></td>
      </tr>
      <tr>
          <td>实验一 单元静态测试工具pclint的使用</td>
          <td><a href="/webzuoye/Public/doc/3.docx""><button type="button" class="btn btn-primary">下载</button></a></td>
      </tr>
  </tbody>
</table>
    </div>
