...
<div class="weizhi">
    <div class="weizhi_title">
        <span class="glyphicon glyphicon-list-alt"></span>作业详情
    </div>
</div>
...
<!--             <table class="table table-bordered text-center">
                <tr class="bg-primary">
                    ...
                    <th class="col-xs-6" style="text-align: center" colspan="6">操作</th>
                </tr>
                <tr>
                    <td>文件一</td>
                    <td><a href="">预览</a></td>
            ...
            <div style="margin-top: 30px;border: 1px solid #eee;box-shadow: 1px 1px 1px 1px #eee;">
                <h4 class="text-center">退回理由</h4>
                <div style="padding:15px;">
                    <?php echo ($data["act_reson"]); ?>
                </div>
            </div>
        </div>
        <div class="col-xs-3"></div>
    ...
    <div class="container" style="margin-top: 30px;padding-bottom: 20px;border: 1px solid #eee;box-shadow: 1px 1px 1px #eee;">
        ...
        <p class="text-center" style="font-size: 10px"><?php echo ($data["act_time"]); ?></p>
