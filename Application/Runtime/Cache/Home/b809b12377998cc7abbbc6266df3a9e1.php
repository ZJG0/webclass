...
<div class="container-fluid text-center" style="margin-top: 30px">
    <form action="<?php echo U('User/saveInfo');?>" method="post" class="form-horizontal ">
        <!-- <div class="col-sm-6">
            <div class="row">
        ...
        <div class="col-sm-6 col-sm-offset-4">
            <div class="row">
             <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="unit" class="form-control" required="required" value="<?php echo ($unit); ?>">
                </div>
              </div>
            </div>
        </div>
