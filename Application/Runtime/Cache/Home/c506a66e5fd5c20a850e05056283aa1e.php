...
<div class="container-fluid" style="padding:0;">
        ...
        <div style="width:151px;float:right;border-left: 2px #1082C9 solid;">
            <div class="dropdown1">
                <button class="dropbtn1">
                    你好，教师&nbsp;&nbsp;<span style="position: relative;top:3px;" class="glyphicon glyphicon-chevron-down"></span>
                </button>
                <div class="dropdown-content1">
                    <!-- <a href="<?php echo U('Admin/updataUserInfo');?>" target="cont"><span class="glyphicon glyphicon-user"></span>&nbsp;修改个人信息</a> -->
                    <a href="<?php echo U('Admin/updataPwd');?>" target="cont"><span class="glyphicon glyphicon-lock"></span>&nbsp;修改密码</a>
                    <a href="<?php echo U('Index/outLogin');?>"><span class="glyphicon glyphicon-log-out"></span>&nbsp;退出</a>
                </div>
            </div>
        </div>
    </div>
    <div class="menu">
        ...
        <ul id="menu">
            <li>
                <a href="<?php echo U('Admin/inform');?>" target="cont">
            ...
            <li>
                <a href="">
                    ...
                    用户管理
                    <span class="glyphicon glyphicon-chevron-down" style="display: inline-block;width:20px;position: relative;left:80px;"></span>
                </a>
                <ul>
                    <li>
                        <a href="<?php echo U('Admin/addUser');?>" target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            增添新用户
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Admin/allUser');?>" target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            查询用户信息
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="<?php echo U('Admin/newInform');?>"  target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            发布通知
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('allInform');?>"  target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            已发通知
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="<?php echo U('Admin/weiShenPi');?>"  target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            未审批 <span class="badge actNum" ></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Admin/yiTongGuo');?>"  target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            已通过 
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Admin/yiBoHui');?>"  target="cont">
                            <span class="glyphicon glyphicon-minus"></span>
                            已驳回
                        </a>
                    </li>
    ...
    <div class="cont">
        <iframe src="<?php echo U('Admin/inform');?>" name="cont" marginheight="0" marginwidth="0" frameborder="0" width="100%" id="iframepage"></iframe>
    </div>
...
<script>
    ...
    function getNum(){
        $.get("<?php echo U('Admin/getNum');?>",function(res){
            if(res>0){
               $(".actNum").text(res); 
           }else{
            $(".actNum").remove();
