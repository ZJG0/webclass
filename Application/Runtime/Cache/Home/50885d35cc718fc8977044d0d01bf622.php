...
<div class="weizhi">
    <div class="weizhi_title">
        <span class="glyphicon glyphicon-list-alt"></span>未通过
    </div>
</div>
  ...
  <div class="container-fluid padTa">
    <table class="table gTable table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <span class="glyphicon glyphicon-edit span1" style="color:#c21f3c"><a href="<?php echo U('User/noPassContent');?>?id=<?php echo ($vo["id"]); ?>" target="cont" target="cont">详情</a></span>
                </td>
    ...
    <div class="row">
       <div class="col-sm-5 " style="text-align: right">
            <ul class="pagination">
                ...
                <?php $__FOR_START_10448__=0;$__FOR_END_10448__=$allNum;for($i=$__FOR_START_10448__;$i < $__FOR_END_10448__;$i+=1){ ?><li class="x<?php echo ($i+1); ?>"><a   href="<?php echo U('User/daiShenPi');?>?page=<?php echo ($i+1); ?>"><?php echo ($i+1); ?></a></li><?php } ?>
